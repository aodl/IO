...
defines one execution identity and no adapter. Do not use SNS or unrelated
mainnet/system canister IDs as deployment targets.
...
- `10292412127977304661` is the two-year protected NNS neuron and must not be
  touched.
...
- Keep value-moving canister targets out of unrelated mainnet/system canister IDs.
