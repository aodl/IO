...
mark_phase_done 17-one-day-reward-observed \
  "proposal_id=${proposal_id} event_round=${event_round} classification=ProposalBearing processed_count=1 accumulated_policy_credit=1000000000000000000; see ${observation_log}"
