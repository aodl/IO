...
| Internal ICP fees | Fees that relocate existing claim backing consume the excluded Dynamic anchor. Fresh ingress/maturity delivery fees reduce fresh net credits. The anchor-restoration fee is paid from fresh TwoYear maturity; redemption uses its gross/net quote; external fees create no entitlement. | Canonical local ledger fee. | NNS/Stream fee capacity and TwoYear restoration | Anchored fee policy is frozen by the replacement ADR |
