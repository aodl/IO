...
| Pooled parent memo/followee | Approved: memo `0` is the fixed deterministic staking nonce, and the parent follows protected two-year neuron `10_292_412_127_977_304_661`. Validation requires the followee to equal `two_year_neuron_id`. The permanent neuron is recorded and operationally expected to follow alpha-vote neuron `2_947_465_672_511_369`; that fact remains subject to separately authorized mainnet verification, and IO does not change it. | Local evidence memo `42_001` remains valid historical evidence and is not production authority. | Production NNS-manager args/readiness and collision guard | Resolved production configuration; protected-mainnet audit separately verifies the existing permanent following without this task making a call |
