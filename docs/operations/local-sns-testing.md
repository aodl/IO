...
4. Later milestones will wire local SNS governance reads.
...
The harness starts as topology and config smoke tests:
...
Future milestones can extend this harness into local SNS governance reads, local SNS ledger/index integration, and SNS root/controller lifecycle tests after the required artifacts and launch process are established.
