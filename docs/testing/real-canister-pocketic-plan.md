...
3. Add failure-injection upgrade/retry/idempotency tests around partially completed finalized-governance active-stake refresh and future real scanner operations.
